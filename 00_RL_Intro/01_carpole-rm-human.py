...
balancing dynamic control with limited actions and noisy observations. If you're curious, I can 
also walk you through how different RL strategies approach this challenge.
"""
...
# Create the Cart Pole environment with visual rendering
...
# Simulation settings - how many episodes to run and max steps per episode
